...
> 1.6.0.0版本为全新架构版本，将不在兼容1.5.2.0及其以下版本，请选择评估后进行升级。
...
工具类 dll 下载地址 [DapperHelper.Orcale Framework 4.7.2 1.2.2.0](https://gitee.com/XIAOANDX/dapper-helper/releases/tag/v1.2.2.0)
